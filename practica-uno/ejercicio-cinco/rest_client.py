...
nuevo_animal = {
    ...
    "edad": 10,
    "peso": 4000,
    "animal_type": "Mamifero"  # Tipo de animal especificado
}
...
# Agregar el animal león utilizando la fábrica
nuevo_animal_leon = {
    "nombre": "León",
...
response = requests.post(base_url, json=nuevo_animal_leon)
if response.status_code == 201:
    print("\nAgregar el animal León:")
    print("Animal creado exitosamente:")
    print(response.json())
else:
    print("Error al agregar el animal León.")
